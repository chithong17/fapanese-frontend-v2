...
export function PassageView({ passage }: PassageViewProps) {
  return (
    <div className="w-full">
      ...
      <div className="p-4 md:p-6 bg-gray-50 border border-gray-200 rounded-lg max-h-96 overflow-y-auto">
        <h3 className="text-lg md:text-xl font-semibold mb-3 text-gray-800">
          {passage.topic}
        </h3>
        <p
          className="text-base md:text-lg lg:text-xl leading-relaxed whitespace-pre-wrap"
